...
module.exports = function (app) {
    ...
    app.get('/orders', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, orderService.getOrders()];
                case 1:
                    data = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    app.get('/orders/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var data, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, orderService.getOrderById(req.params.id)
                        //console.log(data.)
                    ];
                case 1:
                    data = _a.sent();
    ...
    app.post('/add-order', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, orderService.createOrder(data)];
                case 2:
                    id = _a.sent();
    ...
    app.get('/add-customerid', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    app.post('/add-customerid', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    app.get('/add-orderdate', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            res.render('add-orderdate');
            return [2 /*return*/];
        });
    }); });
    app.post('/add-orderdate', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    app.get('/add-order-confirmation', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            res.render('add-order-confirmation', req.session.product);
            return [2 /*return*/];
        });
    }); });
    app.post('/add-order-confirmation', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var data, id, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
